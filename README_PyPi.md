...
- `Command-line version`:
  - See the [Annotation CLI integration guide](https://github.com/byemaxx/MetaX/blob/main/Docs/Annotation_CLI.md) for global and unit-specific commands, configuration files, result JSON, exit codes, and subprocess integration.
