...
class Ui_metaX_main(object):
    def setupUi(self, metaX_main):
        ...
        self.page_2.setGeometry(QtCore.QRect(0, 0, 501, 501))
        ...
        self.page.setGeometry(QtCore.QRect(0, 0, 1009, 463))
        self.page.setObjectName("page")
        self.gridLayout_26 = QtWidgets.QGridLayout(self.page)
        self.gridLayout_26.setObjectName("gridLayout_26")
        self.verticalLayout_basic_plot = QtWidgets.QVBoxLayout()
        self.verticalLayout_basic_plot.setObjectName("verticalLayout_basic_plot")
        self.gridLayout_26.addLayout(self.verticalLayout_basic_plot, 0, 0, 1, 1)
        self.toolBox.addItem(self.page, "")
        self.page_3 = QtWidgets.QWidget()
        self.page_3.setGeometry(QtCore.QRect(0, 0, 920, 413))
        self.page_3.setObjectName("page_3")
        self.gridLayout_29 = QtWidgets.QGridLayout(self.page_3)
        self.gridLayout_29.setObjectName("gridLayout_29")
        self.comboBox_table4pca = QtWidgets.QComboBox(self.page_3)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.comboBox_table4pca.addItem("")
        self.comboBox_table4pca.addItem("")
        self.gridLayout_29.addWidget(self.comboBox_table4pca, 0, 0, 1, 1)
        self.checkBox_pca_if_show_lable = QtWidgets.QCheckBox(self.page_3)
        ...
        self.gridLayout_29.addWidget(self.checkBox_pca_if_show_lable, 1, 0, 1, 1)
        self.pushButton_plot_pca_sns = QtWidgets.QPushButton(self.page_3)
        ...
        self.gridLayout_29.addWidget(self.pushButton_plot_pca_sns, 0, 1, 2, 1)
        self.toolBox.addItem(self.page_3, "")
        self.page_4 = QtWidgets.QWidget()
        self.page_4.setGeometry(QtCore.QRect(0, 0, 1009, 463))
        ...
        self.gridLayout_30.addWidget(self.label_33, 4, 2, 1, 1)
        self.comboBox_basic_hetatmap_scale = QtWidgets.QComboBox(self.page_4)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.comboBox_basic_hetatmap_scale.addItem("")
        self.comboBox_basic_hetatmap_scale.addItem("")
        self.gridLayout_30.addWidget(self.comboBox_basic_hetatmap_scale, 6, 6, 1, 1)
        ...
        self.gridLayout_30.addWidget(self.label_34, 4, 0, 1, 1)
        self.label_32 = QtWidgets.QLabel(self.page_4)
        self.label_32.setObjectName("label_32")
        self.gridLayout_30.addWidget(self.label_32, 1, 0, 1, 1)
        self.checkBox_basic_hetatmap_col_cluster = QtWidgets.QCheckBox(self.page_4)
        ...
        self.gridLayout_30.addWidget(self.checkBox_basic_hetatmap_col_cluster, 5, 6, 1, 1)
        ...
        self.gridLayout_30.addWidget(self.label_31, 6, 2, 1, 1)
        self.listWidget_list_for_ploting = QtWidgets.QListWidget(self.page_4)
        ...
        self.gridLayout_30.addWidget(self.listWidget_list_for_ploting, 2, 1, 9, 1)
        self.pushButton_basic_heatmap_drop_item = QtWidgets.QPushButton(self.page_4)
        ...
        self.gridLayout_30.addWidget(self.pushButton_basic_heatmap_drop_item, 5, 0, 1, 1)
        self.label_basic_hetatmap_group = QtWidgets.QLabel(self.page_4)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.gridLayout_30.addWidget(self.label_basic_hetatmap_group, 0, 0, 1, 1)
        self.pushButton_basic_heatmap_add = QtWidgets.QPushButton(self.page_4)
        ...
        self.gridLayout_30.addWidget(self.pushButton_basic_heatmap_add, 1, 6, 1, 1)
        self.checkBox_basic_hetatmap_row_cluster = QtWidgets.QCheckBox(self.page_4)
        ...
        self.gridLayout_30.addWidget(self.checkBox_basic_hetatmap_row_cluster, 5, 2, 1, 1)
        self.radioButton_basic_heamap_function = QtWidgets.QRadioButton(self.page_4)
        ...
        self.gridLayout_30.addWidget(self.radioButton_basic_heamap_function, 0, 2, 1, 2)
        self.comboBox_basic_heatmap_selection_list = QtWidgets.QComboBox(self.page_4)
        self.comboBox_basic_heatmap_selection_list.setObjectName("comboBox_basic_heatmap_selection_list")
        self.gridLayout_30.addWidget(self.comboBox_basic_heatmap_selection_list, 1, 1, 1, 5)
        self.radioButton_basic_heatmap_taxa = QtWidgets.QRadioButton(self.page_4)
        ...
        self.gridLayout_30.addWidget(self.radioButton_basic_heatmap_taxa, 0, 6, 1, 1)
        self.spinBox_basic_heatmap_height = QtWidgets.QSpinBox(self.page_4)
        ...
        self.gridLayout_30.addWidget(self.spinBox_basic_heatmap_height, 4, 6, 1, 1)
        ...
        self.gridLayout_30.addLayout(self.verticalLayout_basic_heatmap_group, 0, 1, 1, 1)
        self.pushButton_basic_heatmap_clean_list = QtWidgets.QPushButton(self.page_4)
        ...
        self.gridLayout_30.addWidget(self.pushButton_basic_heatmap_clean_list, 6, 0, 1, 1)
        ...
        self.gridLayout_30.addWidget(self.label_35, 3, 2, 1, 1)
        self.spinBox_basic_heatmap_width = QtWidgets.QSpinBox(self.page_4)
        ...
        self.gridLayout_30.addWidget(self.spinBox_basic_heatmap_width, 3, 6, 1, 1)
        self.pushButton_basic_heatmap_plot = QtWidgets.QPushButton(self.page_4)
        ...
        self.gridLayout_30.addWidget(self.pushButton_basic_heatmap_plot, 7, 2, 1, 5)
        self.toolBox.addItem(self.page_4, "")
        self.gridLayout_8.addWidget(self.toolBox, 0, 1, 1, 1)
        ...
        self.gridLayout_top_heatmap_plot.addWidget(self.comboBox_top_heatmap_table, 2, 0, 1, 1)
        self.label_57 = QtWidgets.QLabel(self.tab_2)
        self.label_57.setObjectName("label_57")
        self.gridLayout_top_heatmap_plot.addWidget(self.label_57, 0, 1, 1, 1)
        ...
        self.gridLayout_top_heatmap_plot.addWidget(self.lineEdit_top_heatmap_width, 4, 0, 1, 1)
        self.label_59 = QtWidgets.QLabel(self.tab_2)
        self.label_59.setObjectName("label_59")
        self.gridLayout_top_heatmap_plot.addWidget(self.label_59, 3, 0, 1, 1)
        ...
        self.gridLayout_top_heatmap_plot.addWidget(self.label_60, 3, 1, 1, 1)
        ...
        self.gridLayout_top_heatmap_plot.addWidget(self.lineEdit_top_heatmap_length, 4, 1, 1, 1)
        ...
        self.comboBox_top_heatmap_sort_type.addItem("")
        self.comboBox_top_heatmap_sort_type.addItem("")
        self.gridLayout_top_heatmap_plot.addWidget(self.comboBox_top_heatmap_sort_type, 2, 1, 1, 1)
        ...
        self.gridLayout_top_heatmap_plot.addWidget(self.lineEdit_top_heatmap_number, 4, 2, 1, 1)
        self.label_58 = QtWidgets.QLabel(self.tab_2)
        self.label_58.setObjectName("label_58")
        self.gridLayout_top_heatmap_plot.addWidget(self.label_58, 3, 2, 1, 1)
        self.label_30 = QtWidgets.QLabel(self.tab_2)
        self.label_30.setObjectName("label_30")
        self.gridLayout_top_heatmap_plot.addWidget(self.label_30, 0, 2, 1, 1)
        ...
        self.gridLayout_top_heatmap_plot.addWidget(self.lineEdit_top_heatmap_pvalue, 2, 2, 1, 1)
        self.label_38 = QtWidgets.QLabel(self.tab_2)
        self.label_38.setObjectName("label_38")
        self.gridLayout_top_heatmap_plot.addWidget(self.label_38, 0, 3, 1, 1)
        ...
        self.gridLayout_top_heatmap_plot.addWidget(self.comboBox_top_heatmap_cmap, 2, 3, 1, 1)
        self.label_62 = QtWidgets.QLabel(self.tab_2)
        self.label_62.setObjectName("label_62")
        self.gridLayout_top_heatmap_plot.addWidget(self.label_62, 3, 3, 1, 1)
        ...
        self.gridLayout_top_heatmap_plot.addWidget(self.pushButton_plot_top_heatmap, 0, 4, 4, 1)
        ...
        self.gridLayout_top_heatmap_plot.addWidget(self.pushButton_get_top_cross_table, 4, 4, 1, 1)
        ...
        self.gridLayout_16.addWidget(self.spinBox_fc_plot_width, 7, 0, 1, 1)
        ...
        self.gridLayout_16.addWidget(self.spinBox_fc_plot_height, 7, 1, 1, 1)
        ...
        self.spinBox_tflink_height.setProperty("value", 10)
        ...
        self.comboBox_others_hetatmap_scale.addItem("")
        self.comboBox_others_hetatmap_scale.addItem("")
        self.gridLayout_4.addWidget(self.comboBox_others_hetatmap_scale, 6, 1, 1, 1)
        ...
        self.gridLayout_4.addWidget(self.pushButton_others_plot_line, 5, 7, 1, 2)
        ...
        self.gridLayout_4.addWidget(self.pushButton_others_plot_heatmap, 6, 7, 1, 2)
        ...
        self.gridLayout_4.addWidget(self.checkBox_others_hetatmap_row_cluster, 5, 5, 1, 1)
        ...
        self.checkBox_others_hetatmap_col_cluster.setLayoutDirection(QtCore.Qt.LeftToRight)
        ...
        self.gridLayout_4.addWidget(self.checkBox_others_hetatmap_col_cluster, 6, 5, 1, 1)
        ...
        metaX_main.setTabOrder(self.lineEdit_deseq2_pvalue, self.listWidget_table_list)
    ...
    def retranslateUi(self, metaX_main):
        ...
        self.toolBox_2.setItemText(self.toolBox_2.indexOf(self.page_2), _translate("metaX_main", "Basic Info"))
        ...
        self.toolBox.setItemText(self.toolBox.indexOf(self.page), _translate("metaX_main", "● Function Overview"))
        ...
        self.toolBox.setItemText(self.toolBox.indexOf(self.page_3), _translate("metaX_main", "● PCA"))
        ...
        self.comboBox_basic_hetatmap_scale.setItemText(2, _translate("metaX_main", "column"))
        self.comboBox_basic_hetatmap_scale.setItemText(3, _translate("metaX_main", "both"))
        ...
        self.toolBox.setItemText(self.toolBox.indexOf(self.page_4), _translate("metaX_main", "● Heatmap"))
        ...
        self.comboBox_top_heatmap_scale.setItemText(1, _translate("metaX_main", "None"))
        self.comboBox_top_heatmap_scale.setItemText(2, _translate("metaX_main", "column"))
        ...
        self.lineEdit_deseq2_log2fc.setText(_translate("metaX_main", "2"))
