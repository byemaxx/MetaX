...
class Ui_metaX_main(object):
    def setupUi(self, metaX_main):
        ...
        self.page_2.setGeometry(QtCore.QRect(0, 0, 439, 513))
        ...
        self.comboBox_table4pca.addItem("")
        self.comboBox_table4pca.addItem("")
        self.gridLayout_26.addWidget(self.comboBox_table4pca, 0, 0, 1, 1)
        ...
        self.gridLayout_26.addWidget(self.pushButton_plot_pca_sns, 0, 1, 2, 1)
        ...
        self.gridLayout_26.addWidget(self.checkBox_pca_if_show_lable, 1, 0, 1, 1)
