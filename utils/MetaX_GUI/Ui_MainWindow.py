...
class Ui_metaX_main(object):
    def setupUi(self, metaX_main):
        ...
        self.radioButton_basic_heamap_function = QtWidgets.QRadioButton(self.tab_13)
        self.radioButton_basic_heamap_function.setEnabled(False)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.radioButton_basic_heamap_function.sizePolicy().hasHeightForWidth())
        self.radioButton_basic_heamap_function.setSizePolicy(sizePolicy)
        self.radioButton_basic_heamap_function.setCheckable(True)
        self.radioButton_basic_heamap_function.setChecked(False)
        self.radioButton_basic_heamap_function.setObjectName("radioButton_basic_heamap_function")
        self.gridLayout_23.addWidget(self.radioButton_basic_heamap_function, 0, 5, 1, 1)
        ...
        self.spinBox_basic_heatmap_width.setProperty("value", 10)
        ...
        self.radioButton_basic_heatmap_taxa = QtWidgets.QRadioButton(self.tab_13)
        self.radioButton_basic_heatmap_taxa.setEnabled(False)
        self.radioButton_basic_heatmap_taxa.setObjectName("radioButton_basic_heatmap_taxa")
        self.gridLayout_23.addWidget(self.radioButton_basic_heatmap_taxa, 0, 6, 1, 1)
        ...
        self.gridLayout_23.addWidget(self.listWidget_list_for_ploting, 6, 2, 10, 3)
        ...
        self.gridLayout_6.addWidget(self.spinBox_network_width, 2, 1, 1, 1)
        ...
        self.gridLayout_6.addWidget(self.pushButton_plot_network, 4, 0, 1, 4)
        ...
        self.gridLayout_6.addWidget(self.spinBox_network_height, 2, 3, 1, 1)
        ...
        self.gridLayout_4.addWidget(self.spinBox_tflink_height, 5, 3, 1, 1)
        ...
        self.gridLayout_4.addWidget(self.pushButton_others_get_intensity_matrix, 4, 7, 1, 2)
        ...
        self.gridLayout_4.addWidget(self.line_3, 3, 0, 1, 9)
        ...
        self.comboBox_tflink_hetatmap_scale.addItem("")
        self.comboBox_tflink_hetatmap_scale.addItem("")
        self.gridLayout_4.addWidget(self.comboBox_tflink_hetatmap_scale, 6, 1, 1, 1)
        ...
        self.gridLayout_4.addWidget(self.spinBox_tflink_width, 5, 1, 1, 1)
        ...
        self.gridLayout_4.addLayout(self.gridLayout_tflink_group, 4, 1, 1, 6)
        ...
        self.gridLayout_4.addWidget(self.label_61, 6, 2, 1, 1)
        ...
        self.gridLayout_4.addWidget(self.pushButton_others_fresh_taxa_func, 2, 1, 1, 6)
        ...
        self.gridLayout_4.addWidget(self.comboBox_tflink_cmap, 6, 3, 1, 1)
        ...
        self.gridLayout_4.addWidget(self.checkBox_tflink_hetatmap_row_cluster, 5, 4, 1, 1)
        ...
        self.gridLayout_4.addWidget(self.checkBox_tflink_hetatmap_col_cluster, 6, 4, 1, 1)
        ...
        self.gridLayout_4.addWidget(self.checkBox_tflink_hetatmap_rename_taxa, 6, 5, 1, 1)
        ...
        self.gridLayout_4.addWidget(self.pushButton_others_plot_line, 5, 6, 1, 3)
        ...
        self.gridLayout_4.addWidget(self.pushButton_others_plot_heatmap, 6, 6, 1, 3)
    ...
    def retranslateUi(self, metaX_main):
        ...
        self.toolBox_2.setItemText(self.toolBox_2.indexOf(self.page_2), _translate("metaX_main", "● Taxa Stast"))
        self.pushButton_overview_func_plot.setText(_translate("metaX_main", "Plot Function Stast"))
        self.toolBox_2.setItemText(self.toolBox_2.indexOf(self.page_5), _translate("metaX_main", "● Function Stast"))
        ...
        self.label_69.setText(_translate("metaX_main", "Groups"))
        ...
        self.radioButton_basic_heamap_function.setText(_translate("metaX_main", "Functions"))
        ...
        self.radioButton_basic_heatmap_taxa.setText(_translate("metaX_main", "Taxa"))
