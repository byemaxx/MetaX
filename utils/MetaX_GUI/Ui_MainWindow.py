...
class Ui_metaX_main(object):
    ...
    def retranslateUi(self, metaX_main):
        ...
        self.comboBox_outlier_detection.setItemText(4, _translate("metaX_main", "Zero-Inflated-Poisson"))
        self.comboBox_outlier_detection.setItemText(5, _translate("metaX_main", "Negative-Binomial"))
