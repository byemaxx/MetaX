...
class Ui_metaX_main(object):
    def setupUi(self, metaX_main):
        ...
        self.checkBox_calculate_protein_rank_by_intensity = QtWidgets.QCheckBox(self.tab_set_taxa_func)
        self.checkBox_calculate_protein_rank_by_intensity.setEnabled(False)
        self.checkBox_calculate_protein_rank_by_intensity.setObjectName("checkBox_calculate_protein_rank_by_intensity")
        self.gridLayout_37.addWidget(self.checkBox_calculate_protein_rank_by_intensity, 1, 2, 1, 1)
    ...
    def retranslateUi(self, metaX_main):
        ...
        self.label_135.setText(_translate("metaX_main", "Method of Protein Inference"))
        self.checkBox_infrence_protein_by_sample.setText(_translate("metaX_main", "Inference by each Sample"))
        self.checkBox_calculate_protein_rank_by_intensity.setText(_translate("metaX_main", "Weighting by Intensity"))
