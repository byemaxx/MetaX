...
class Ui_Settings(object):
    def setupUi(self, Settings):
        ...
        self.checkBox_use_local_js_assets = QtWidgets.QCheckBox(self.page_2)
        self.checkBox_use_local_js_assets.setChecked(True)
        self.checkBox_use_local_js_assets.setObjectName("checkBox_use_local_js_assets")
        self.gridLayout_5.addWidget(self.checkBox_use_local_js_assets, 0, 2, 1, 1)
        ...
        self.page_3.setGeometry(QtCore.QRect(0, 0, 1008, 623))
        ...
        self.lineEdit_metatree_dir_path = QtWidgets.QLineEdit(self.page_3)
        self.lineEdit_metatree_dir_path.setObjectName("lineEdit_metatree_dir_path")
        self.horizontalLayout.addWidget(self.lineEdit_metatree_dir_path)
        self.pushButton_open_metatree_dir_path = QtWidgets.QPushButton(self.page_3)
        self.pushButton_open_metatree_dir_path.setObjectName("pushButton_open_metatree_dir_path")
        self.horizontalLayout.addWidget(self.pushButton_open_metatree_dir_path)
    ...
    def retranslateUi(self, Settings):
        ...
        self.checkBox_use_local_js_assets.setToolTip(_translate("Settings", "When checked, interactive plots load instantly and work offline using local libraries. Uncheck this before exporting HTML reports if you plan to share them with others, so their browsers can download the libraries from the internet."))
        self.checkBox_use_local_js_assets.setText(_translate("Settings", "Use Local JS Assets (Offline/Fast)"))
        self.label.setText(_translate("Settings", "HeatMap"))
        self.checkBox_stat_mean_by_zero_dominant.setText(_translate("Settings", "Calculate Non-Zero Mean (0 if zeros >50%; else mean of non-zeros) for Each Group"))
        ...
        self.label_28.setText(_translate("Settings", "MetaTree Path"))
        self.pushButton_open_metatree_dir_path.setText(_translate("Settings", "Open"))
