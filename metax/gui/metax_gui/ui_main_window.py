...
class Ui_metaX_main(object):
    def setupUi(self, metaX_main):
        ...
        self.checkBox_pep_direct_to_otf_use_unit_aware_annotate = QtWidgets.QCheckBox(self.tab_6)
        self.checkBox_pep_direct_to_otf_use_unit_aware_annotate.setObjectName("checkBox_pep_direct_to_otf_use_unit_aware_annotate")
        self.gridLayout_74.addWidget(self.checkBox_pep_direct_to_otf_use_unit_aware_annotate, 5, 0, 1, 1)
        ...
        self.lineEdit_pep_direct_to_otf_unit_aware_manifest_path = QtWidgets.QLineEdit(self.tab_6)
        self.lineEdit_pep_direct_to_otf_unit_aware_manifest_path.setEnabled(False)
        self.lineEdit_pep_direct_to_otf_unit_aware_manifest_path.setObjectName("lineEdit_pep_direct_to_otf_unit_aware_manifest_path")
        self.gridLayout_74.addWidget(self.lineEdit_pep_direct_to_otf_unit_aware_manifest_path, 6, 2, 1, 1)
        ...
        self.label_unit_aware_manifest = QtWidgets.QLabel(self.tab_6)
        self.label_unit_aware_manifest.setObjectName("label_unit_aware_manifest")
        self.gridLayout_74.addWidget(self.label_unit_aware_manifest, 6, 0, 1, 1)
        ...
        self.pushButton_open_pep_direct_to_otf_unit_aware_manifest_path = QtWidgets.QPushButton(self.tab_6)
        self.pushButton_open_pep_direct_to_otf_unit_aware_manifest_path.setEnabled(False)
        self.pushButton_open_pep_direct_to_otf_unit_aware_manifest_path.setObjectName("pushButton_open_pep_direct_to_otf_unit_aware_manifest_path")
        self.gridLayout_74.addWidget(self.pushButton_open_pep_direct_to_otf_unit_aware_manifest_path, 6, 3, 1, 1)
        self.horizontalLayout_140 = QtWidgets.QHBoxLayout()
        self.horizontalLayout_140.setObjectName("horizontalLayout_140")
        self.pushButton_pep_direct_to_otf_unit_aware_settings = QtWidgets.QPushButton(self.tab_6)
        self.pushButton_pep_direct_to_otf_unit_aware_settings.setEnabled(False)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.pushButton_pep_direct_to_otf_unit_aware_settings.sizePolicy().hasHeightForWidth())
        self.pushButton_pep_direct_to_otf_unit_aware_settings.setSizePolicy(sizePolicy)
        self.pushButton_pep_direct_to_otf_unit_aware_settings.setObjectName("pushButton_pep_direct_to_otf_unit_aware_settings")
        self.horizontalLayout_140.addWidget(self.pushButton_pep_direct_to_otf_unit_aware_settings)
        self.label_pep_direct_to_otf_use_unit_aware_genome_threshold = QtWidgets.QLabel(self.tab_6)
        self.label_pep_direct_to_otf_use_unit_aware_genome_threshold.setEnabled(False)
        self.label_pep_direct_to_otf_use_unit_aware_genome_threshold.setAlignment(QtCore.Qt.AlignRight|QtCore.Qt.AlignTrailing|QtCore.Qt.AlignVCenter)
        self.label_pep_direct_to_otf_use_unit_aware_genome_threshold.setObjectName("label_pep_direct_to_otf_use_unit_aware_genome_threshold")
        self.horizontalLayout_140.addWidget(self.label_pep_direct_to_otf_use_unit_aware_genome_threshold)
        self.comboBox_pep_direct_to_otf_use_unit_aware_genome_threshold = QtWidgets.QComboBox(self.tab_6)
        self.comboBox_pep_direct_to_otf_use_unit_aware_genome_threshold.setEnabled(False)
        self.comboBox_pep_direct_to_otf_use_unit_aware_genome_threshold.setObjectName("comboBox_pep_direct_to_otf_use_unit_aware_genome_threshold")
        self.comboBox_pep_direct_to_otf_use_unit_aware_genome_threshold.addItem("")
        self.comboBox_pep_direct_to_otf_use_unit_aware_genome_threshold.addItem("")
        self.horizontalLayout_140.addWidget(self.comboBox_pep_direct_to_otf_use_unit_aware_genome_threshold)
        ...
        self.checkBox_pep_direct_to_otf_use_unit_aware_annotate.toggled['bool'].connect(self.pushButton_pep_direct_to_otf_unit_aware_settings.setEnabled) # type: ignore
        self.checkBox_pep_direct_to_otf_use_unit_aware_annotate.toggled['bool'].connect(self.lineEdit_pep_direct_to_otf_unit_aware_manifest_path.setEnabled) # type: ignore
        self.checkBox_pep_direct_to_otf_use_unit_aware_annotate.toggled['bool'].connect(self.pushButton_open_pep_direct_to_otf_unit_aware_manifest_path.setEnabled) # type: ignore
        self.checkBox_pep_direct_to_otf_use_unit_aware_annotate.toggled['bool'].connect(self.label_pep_direct_to_otf_use_unit_aware_genome_threshold.setEnabled) # type: ignore
        self.checkBox_pep_direct_to_otf_use_unit_aware_annotate.toggled['bool'].connect(self.comboBox_pep_direct_to_otf_use_unit_aware_genome_threshold.setEnabled) # type: ignore
...
""))
        ...
        self.checkBox_pep_direct_to_otf_use_unit_aware_annotate.setText(_translate("metaX_main", "Use unit-aware annotation"))
        ...
        self.label_unit_aware_manifest.setText(_translate("metaX_main", "MetaUmbra unit-aware manifest"))
        ...
        self.pushButton_open_pep_direct_to_otf_unit_aware_manifest_path.setText(_translate("metaX_main", "Open"))
        self.pushButton_pep_direct_to_otf_unit_aware_settings.setText(_translate("metaX_main", "Unit-aware Settings..."))
        self.label_pep_direct_to_otf_use_unit_aware_genome_threshold.setText(_translate("metaX_main", "Genome threshold"))
        self.comboBox_pep_direct_to_otf_use_unit_aware_genome_threshold.setItemText(0, _translate("metaX_main", "q0.05"))
        self.comboBox_pep_direct_to_otf_use_unit_aware_genome_threshold.setItemText(1, _translate("metaX_main", "q0.01"))
