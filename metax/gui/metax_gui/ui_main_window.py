...
class Ui_metaX_main(object):
    def setupUi(self, metaX_main):
        ...
        self.pushButton_generate_report = QtWidgets.QPushButton(self.tab)
        self.pushButton_generate_report.setObjectName("pushButton_generate_report")
        self.gridLayout.addWidget(self.pushButton_generate_report, 7, 0, 1, 1)
        ...
        self.page_2.setGeometry(QtCore.QRect(0, 0, 623, 818))
        ...
        self.page_5.setGeometry(QtCore.QRect(0, 0, 450, 71))
        ...
        self.page.setGeometry(QtCore.QRect(0, 0, 389, 105))
        ...
        self.gridLayout_25.addWidget(self.label_39, 7, 0, 1, 1)
        ...
        self.horizontalLayout_outlier_intensity_percentile_threshold = QtWidgets.QHBoxLayout()
        self.horizontalLayout_outlier_intensity_percentile_threshold.setObjectName("horizontalLayout_outlier_intensity_percentile_threshold")
        self.label_outlier_intensity_percentile_threshold = QtWidgets.QLabel(self.tab_set_taxa_func)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.label_outlier_intensity_percentile_threshold.sizePolicy().hasHeightForWidth())
        self.label_outlier_intensity_percentile_threshold.setSizePolicy(sizePolicy)
        self.label_outlier_intensity_percentile_threshold.setObjectName("label_outlier_intensity_percentile_threshold")
        self.horizontalLayout_outlier_intensity_percentile_threshold.addWidget(self.label_outlier_intensity_percentile_threshold)
        self.doubleSpinBox_outlier_intensity_percentile_threshold = QtWidgets.QDoubleSpinBox(self.tab_set_taxa_func)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.doubleSpinBox_outlier_intensity_percentile_threshold.sizePolicy().hasHeightForWidth())
        self.doubleSpinBox_outlier_intensity_percentile_threshold.setSizePolicy(sizePolicy)
        self.doubleSpinBox_outlier_intensity_percentile_threshold.setMaximum(100.0)
        self.doubleSpinBox_outlier_intensity_percentile_threshold.setSingleStep(1.0)
        self.doubleSpinBox_outlier_intensity_percentile_threshold.setProperty("value", 5.0)
        self.doubleSpinBox_outlier_intensity_percentile_threshold.setObjectName("doubleSpinBox_outlier_intensity_percentile_threshold")
        self.horizontalLayout_outlier_intensity_percentile_threshold.addWidget(self.doubleSpinBox_outlier_intensity_percentile_threshold)
        self.horizontalLayout_128.addLayout(self.horizontalLayout_outlier_intensity_percentile_threshold)
        ...
        self.gridLayout_25.addLayout(self.gridLayout_79, 10, 0, 1, 1)
        ...
        self.gridLayout_25.addWidget(self.pushButton_set_multi_table, 11, 0, 1, 1)
        ...
        self.comboBox_taxa_level_to_stast.addItem("")
        self.comboBox_taxa_level_to_stast.addItem("")
        self.horizontalLayout_134.addWidget(self.comboBox_taxa_level_to_stast)
        self.gridLayout_17.addLayout(self.horizontalLayout_134, 1, 1, 1, 1)
        self.gridLayout_25.addLayout(self.gridLayout_17, 1, 0, 1, 1)
        self.checkBox_show_mroe_options_of_set_otf = QtWidgets.QCheckBox(self.tab_set_taxa_func)
        self.checkBox_show_mroe_options_of_set_otf.setObjectName("checkBox_show_mroe_options_of_set_otf")
        self.gridLayout_25.addWidget(self.checkBox_show_mroe_options_of_set_otf, 2, 0, 1, 1)
        self.scrollArea_set_otf_options = QtWidgets.QScrollArea(self.tab_set_taxa_func)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.scrollArea_set_otf_options.sizePolicy().hasHeightForWidth())
        self.scrollArea_set_otf_options.setSizePolicy(sizePolicy)
        self.scrollArea_set_otf_options.setWidgetResizable(True)
        self.scrollArea_set_otf_options.setObjectName("scrollArea_set_otf_options")
        self.scrollAreaWidgetContents_10 = QtWidgets.QWidget()
        self.scrollAreaWidgetContents_10.setGeometry(QtCore.QRect(0, 0, 1253, 253))
        ...
        self.label_241 = QtWidgets.QLabel(self.scrollAreaWidgetContents_10)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.gridLayout_81.addWidget(self.label_241, 0, 0, 1, 1)
        self.checkBox_set_taxa_func_split_func_share_intensity = QtWidgets.QCheckBox(self.scrollAreaWidgetContents_10)
        self.checkBox_set_taxa_func_split_func_share_intensity.setEnabled(False)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.checkBox_set_taxa_func_split_func_share_intensity.sizePolicy().hasHeightForWidth())
        self.checkBox_set_taxa_func_split_func_share_intensity.setSizePolicy(sizePolicy)
        self.checkBox_set_taxa_func_split_func_share_intensity.setChecked(True)
        self.checkBox_set_taxa_func_split_func_share_intensity.setObjectName("checkBox_set_taxa_func_split_func_share_intensity")
        self.gridLayout_81.addWidget(self.checkBox_set_taxa_func_split_func_share_intensity, 0, 3, 1, 1)
        self.checkBox_set_taxa_func_split_func = QtWidgets.QCheckBox(self.scrollAreaWidgetContents_10)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.checkBox_set_taxa_func_split_func.sizePolicy().hasHeightForWidth())
        self.checkBox_set_taxa_func_split_func.setSizePolicy(sizePolicy)
        self.checkBox_set_taxa_func_split_func.setChecked(False)
        self.checkBox_set_taxa_func_split_func.setObjectName("checkBox_set_taxa_func_split_func")
        self.gridLayout_81.addWidget(self.checkBox_set_taxa_func_split_func, 0, 1, 1, 1)
        self.label_243 = QtWidgets.QLabel(self.scrollAreaWidgetContents_10)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.gridLayout_81.addWidget(self.label_243, 2, 0, 1, 1)
        self.checkBox_set_otf_remove_unknown_taxa = QtWidgets.QCheckBox(self.scrollAreaWidgetContents_10)
        self.checkBox_set_otf_remove_unknown_taxa.setChecked(True)
        self.checkBox_set_otf_remove_unknown_taxa.setObjectName("checkBox_set_otf_remove_unknown_taxa")
        self.gridLayout_81.addWidget(self.checkBox_set_otf_remove_unknown_taxa, 1, 1, 1, 2)
        self.label_242 = QtWidgets.QLabel(self.scrollAreaWidgetContents_10)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.gridLayout_81.addWidget(self.label_242, 1, 0, 1, 1)
        self.checkBox_create_protein_table = QtWidgets.QCheckBox(self.scrollAreaWidgetContents_10)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.gridLayout_81.addWidget(self.checkBox_create_protein_table, 4, 0, 1, 1)
        self.lineEdit_set_taxa_func_split_func_sep = QtWidgets.QLineEdit(self.scrollAreaWidgetContents_10)
        ...
        self.gridLayout_81.addWidget(self.lineEdit_set_taxa_func_split_func_sep, 0, 2, 1, 1)
        self.checkBox_set_otf_taxa_and_func_only_from_otf = QtWidgets.QCheckBox(self.scrollAreaWidgetContents_10)
        ...
        self.gridLayout_81.addWidget(self.checkBox_set_otf_taxa_and_func_only_from_otf, 2, 1, 1, 2)
        ...
        self.spinBox_peptide_num_threshold_protein = QtWidgets.QSpinBox(self.scrollAreaWidgetContents_10)
        ...
        self.gridLayout_81.addLayout(self.horizontalLayout_93, 5, 0, 1, 1)
        ...
        self.comboBox_protein_ranking_method = QtWidgets.QComboBox(self.scrollAreaWidgetContents_10)
        ...
        self.gridLayout_81.addLayout(self.horizontalLayout_2, 5, 3, 1, 1)
        ...
        self.gridLayout_81.addWidget(self.label_134, 3, 0, 1, 3)
        ...
        self.horizontalLayout_96.addWidget(self.label_135)
        self.comboBox_method_of_protein_inference = QtWidgets.QComboBox(self.scrollAreaWidgetContents_10)
        ...
        self.comboBox_method_of_protein_inference.addItem("")
        self.comboBox_method_of_protein_inference.addItem("")
        self.horizontalLayout_96.addWidget(self.comboBox_method_of_protein_inference)
        self.gridLayout_81.addLayout(self.horizontalLayout_96, 4, 3, 1, 1)
        self.checkBox_infrence_protein_by_sample = QtWidgets.QCheckBox(self.scrollAreaWidgetContents_10)
        ...
        self.gridLayout_81.addWidget(self.checkBox_infrence_protein_by_sample, 5, 1, 1, 1)
        self.gridLayout_37.addLayout(self.gridLayout_81, 0, 0, 1, 1)
        self.scrollArea_set_otf_options.setWidget(self.scrollAreaWidgetContents_10)
        self.gridLayout_25.addWidget(self.scrollArea_set_otf_options, 3, 0, 1, 1)
        ...
        self.scrollArea_basic_plot_settings = QtWidgets.QScrollArea(self.tab_12)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.scrollArea_basic_plot_settings.sizePolicy().hasHeightForWidth())
        self.scrollArea_basic_plot_settings.setSizePolicy(sizePolicy)
        self.scrollArea_basic_plot_settings.setMaximumSize(QtCore.QSize(16777215, 16777215))
        self.scrollArea_basic_plot_settings.setWidgetResizable(True)
        self.scrollArea_basic_plot_settings.setObjectName("scrollArea_basic_plot_settings")
        self.scrollAreaWidgetContents = QtWidgets.QWidget()
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 1221, 364))
        ...
        self.spinBox_basic_plot_upset_max_rank.setProperty("value", 20)
        ...
        self.scrollArea_basic_plot_settings.setWidget(self.scrollAreaWidgetContents)
        self.gridLayout_26.addWidget(self.scrollArea_basic_plot_settings, 11, 0, 1, 3)
        ...
        self.pushButton_basic_items_pca_plot = QtWidgets.QPushButton(self.tab_13)
        self.pushButton_basic_items_pca_plot.setEnabled(False)
        self.pushButton_basic_items_pca_plot.setObjectName("pushButton_basic_items_pca_plot")
        self.horizontalLayout_107.addWidget(self.pushButton_basic_items_pca_plot)
        ...
        self.pushButton_basic_heatmap_metatree = QtWidgets.QPushButton(self.tab_13)
        self.pushButton_basic_heatmap_metatree.setEnabled(False)
        self.pushButton_basic_heatmap_metatree.setObjectName("pushButton_basic_heatmap_metatree")
        self.horizontalLayout_107.addWidget(self.pushButton_basic_heatmap_metatree)
        ...
        self.scrollArea_basic_heatmap_plot_settings = QtWidgets.QScrollArea(self.tab_13)
        self.scrollArea_basic_heatmap_plot_settings.setWidgetResizable(True)
        self.scrollArea_basic_heatmap_plot_settings.setObjectName("scrollArea_basic_heatmap_plot_settings")
        self.scrollAreaWidgetContents_2 = QtWidgets.QWidget()
        self.scrollAreaWidgetContents_2.setGeometry(QtCore.QRect(0, 0, 960, 213))
        ...
        self.horizontalLayout_133.addWidget(self.label_250)
        self.checkBox_basic_items_pca_show_labels = QtWidgets.QCheckBox(self.scrollAreaWidgetContents_2)
        self.checkBox_basic_items_pca_show_labels.setObjectName("checkBox_basic_items_pca_show_labels")
        self.horizontalLayout_133.addWidget(self.checkBox_basic_items_pca_show_labels)
        self.checkBox_basic_items_pca_js = QtWidgets.QCheckBox(self.scrollAreaWidgetContents_2)
        self.checkBox_basic_items_pca_js.setObjectName("checkBox_basic_items_pca_js")
        self.horizontalLayout_133.addWidget(self.checkBox_basic_items_pca_js)
        self.gridLayout_70.addLayout(self.horizontalLayout_133, 1, 3, 1, 1)
        self.gridLayout_50.addLayout(self.gridLayout_70, 0, 0, 1, 1)
        self.scrollArea_basic_heatmap_plot_settings.setWidget(self.scrollAreaWidgetContents_2)
        self.gridLayout_23.addWidget(self.scrollArea_basic_heatmap_plot_settings, 11, 0, 1, 4)
        ...
        self.gridLayout_72.addLayout(self.horizontalLayout_24, 2, 0, 1, 1)
        ...
        self.horizontalLayout_136.addWidget(self.label_140)
        self.horizontalLayout_139 = QtWidgets.QHBoxLayout()
        self.horizontalLayout_139.setObjectName("horizontalLayout_139")
        self.comboBox_group_control_condition_deseq2_covariates = QtWidgets.QComboBox(self.tab_16)
        self.comboBox_group_control_condition_deseq2_covariates.setObjectName("comboBox_group_control_condition_deseq2_covariates")
        self.horizontalLayout_139.addWidget(self.comboBox_group_control_condition_deseq2_covariates)
        self.horizontalLayout_136.addLayout(self.horizontalLayout_139)
        self.gridLayout_72.addLayout(self.horizontalLayout_136, 2, 1, 1, 1)
        ...
        self.label_251 = QtWidgets.QLabel(self.tab_16)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Maximum, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.horizontalLayout_143.addWidget(self.label_251)
        self.comboBox_multi_de_method = QtWidgets.QComboBox(self.tab_16)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.comboBox_multi_de_method.sizePolicy().hasHeightForWidth())
        self.comboBox_multi_de_method.setSizePolicy(sizePolicy)
        self.comboBox_multi_de_method.setMinimumSize(QtCore.QSize(150, 0))
        self.comboBox_multi_de_method.setObjectName("comboBox_multi_de_method")
        self.comboBox_multi_de_method.addItem("")
        self.comboBox_multi_de_method.addItem("")
        self.comboBox_multi_de_method.addItem("")
        self.horizontalLayout_143.addWidget(self.comboBox_multi_de_method)
        self.checkBox_multi_de_convert_zero_to_nan_before_limma = QtWidgets.QCheckBox(self.tab_16)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.checkBox_multi_de_convert_zero_to_nan_before_limma.sizePolicy().hasHeightForWidth())
        self.checkBox_multi_de_convert_zero_to_nan_before_limma.setSizePolicy(sizePolicy)
        self.checkBox_multi_de_convert_zero_to_nan_before_limma.setObjectName("checkBox_multi_de_convert_zero_to_nan_before_limma")
        self.horizontalLayout_143.addWidget(self.checkBox_multi_de_convert_zero_to_nan_before_limma)
        self.pushButton_run_multi_de = QtWidgets.QPushButton(self.tab_16)
        self.pushButton_run_multi_de.setEnabled(False)
        self.pushButton_run_multi_de.setObjectName("pushButton_run_multi_de")
        self.horizontalLayout_143.addWidget(self.pushButton_run_multi_de)
        self.gridLayout_33.addLayout(self.horizontalLayout_143, 10, 1, 1, 2)
        ...
        self.horizontalLayout_137.addWidget(self.label_247)
        self.horizontalLayout_138 = QtWidgets.QHBoxLayout()
        self.horizontalLayout_138.setObjectName("horizontalLayout_138")
        self.comboBox_deseq2_covariates = QtWidgets.QComboBox(self.tab_19)
        self.comboBox_deseq2_covariates.setObjectName("comboBox_deseq2_covariates")
        self.horizontalLayout_138.addWidget(self.comboBox_deseq2_covariates)
        self.horizontalLayout_137.addLayout(self.horizontalLayout_138)
        self.gridLayout_16.addLayout(self.horizontalLayout_137, 1, 2, 1, 1)
        ...
        self.gridLayout_16.addWidget(self.line, 2, 0, 1, 3)
        ...
        self.checkBox_deseq2_comparing_in_condition.setLayoutDirection(QtCore.Qt.LeftToRight)
        self.checkBox_deseq2_comparing_in_condition.setAutoFillBackground(False)
        ...
        self.gridLayout_16.addWidget(self.label_166, 4, 0, 1, 1)
        self.line_14 = QtWidgets.QFrame(self.tab_19)
        self.line_14.setFrameShape(QtWidgets.QFrame.HLine)
        self.line_14.setFrameShadow(QtWidgets.QFrame.Sunken)
        self.line_14.setObjectName("line_14")
        self.gridLayout_16.addWidget(self.line_14, 5, 0, 1, 3)
        ...
        self.scrollArea_deseq2_plot_settings = QtWidgets.QScrollArea(self.groupBox)
        self.scrollArea_deseq2_plot_settings.setWidgetResizable(True)
        self.scrollArea_deseq2_plot_settings.setObjectName("scrollArea_deseq2_plot_settings")
        self.scrollAreaWidgetContents_4 = QtWidgets.QWidget()
        self.scrollAreaWidgetContents_4.setGeometry(QtCore.QRect(0, 0, 790, 129))
        ...
        self.scrollArea_deseq2_plot_settings.setWidget(self.scrollAreaWidgetContents_4)
        self.gridLayout_55.addWidget(self.scrollArea_deseq2_plot_settings, 2, 0, 1, 2)
        ...
        self.horizontalLayout_141.addWidget(self.label_252)
        self.comboBox_de_method = QtWidgets.QComboBox(self.tab_19)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.comboBox_de_method.sizePolicy().hasHeightForWidth())
        self.comboBox_de_method.setSizePolicy(sizePolicy)
        self.comboBox_de_method.setMinimumSize(QtCore.QSize(150, 0))
        self.comboBox_de_method.setObjectName("comboBox_de_method")
        self.comboBox_de_method.addItem("")
        self.comboBox_de_method.addItem("")
        self.horizontalLayout_141.addWidget(self.comboBox_de_method)
        self.checkBox_de_convert_zero_to_nan_before_limma = QtWidgets.QCheckBox(self.tab_19)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.checkBox_de_convert_zero_to_nan_before_limma.sizePolicy().hasHeightForWidth())
        self.checkBox_de_convert_zero_to_nan_before_limma.setSizePolicy(sizePolicy)
        self.checkBox_de_convert_zero_to_nan_before_limma.setObjectName("checkBox_de_convert_zero_to_nan_before_limma")
        self.horizontalLayout_141.addWidget(self.checkBox_de_convert_zero_to_nan_before_limma)
        self.pushButton_run_de = QtWidgets.QPushButton(self.tab_19)
        self.pushButton_run_de.setEnabled(False)
        self.pushButton_run_de.setObjectName("pushButton_run_de")
        self.horizontalLayout_141.addWidget(self.pushButton_run_de)
        self.gridLayout_16.addLayout(self.horizontalLayout_141, 6, 1, 1, 2)
        ...
        self.scrollArea_cross_heatmap_settings = QtWidgets.QScrollArea(self.groupBox_cross_heatmap_plot)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.scrollAreaWidgetContents_3.setGeometry(QtCore.QRect(0, 0, 1263, 211))
        ...
        self.gridLayout_75.addWidget(self.scrollArea_cross_heatmap_settings, 1, 0, 1, 1)
        ...
        self.scrollArea_co_expression_plot_settings = QtWidgets.QScrollArea(self.tab_5)
        self.scrollArea_co_expression_plot_settings.setWidgetResizable(True)
        self.scrollArea_co_expression_plot_settings.setObjectName("scrollArea_co_expression_plot_settings")
        self.scrollAreaWidgetContents_5 = QtWidgets.QWidget()
        self.scrollAreaWidgetContents_5.setGeometry(QtCore.QRect(0, 0, 736, 175))
        ...
        self.scrollArea_co_expression_plot_settings.setWidget(self.scrollAreaWidgetContents_5)
        self.gridLayout_47.addWidget(self.scrollArea_co_expression_plot_settings, 10, 0, 1, 4)
        ...
        self.scrollArea_expression_trends_plot_settings = QtWidgets.QScrollArea(self.tab_15)
        self.scrollArea_expression_trends_plot_settings.setWidgetResizable(True)
        self.scrollArea_expression_trends_plot_settings.setObjectName("scrollArea_expression_trends_plot_settings")
        self.scrollAreaWidgetContents_6 = QtWidgets.QWidget()
        self.scrollAreaWidgetContents_6.setGeometry(QtCore.QRect(0, 0, 909, 90))
        ...
        self.scrollArea_expression_trends_plot_settings.setWidget(self.scrollAreaWidgetContents_6)
        self.gridLayout_24.addWidget(self.scrollArea_expression_trends_plot_settings, 10, 0, 1, 5)
        ...
        self.scrollArea_taxa_func_link_plot_settings = QtWidgets.QScrollArea(self.tab_8)
        self.scrollArea_taxa_func_link_plot_settings.setWidgetResizable(True)
        self.scrollArea_taxa_func_link_plot_settings.setObjectName("scrollArea_taxa_func_link_plot_settings")
        self.scrollAreaWidgetContents_7 = QtWidgets.QWidget()
        self.scrollAreaWidgetContents_7.setGeometry(QtCore.QRect(0, 0, 1188, 138))
        ...
        self.scrollArea_taxa_func_link_plot_settings.setWidget(self.scrollAreaWidgetContents_7)
        self.gridLayout_4.addWidget(self.scrollArea_taxa_func_link_plot_settings, 9, 0, 1, 4)
        ...
        self.scrollArea_taxa_func_link_net_plot_settings = QtWidgets.QScrollArea(self.tab_9)
        self.scrollArea_taxa_func_link_net_plot_settings.setWidgetResizable(True)
        self.scrollArea_taxa_func_link_net_plot_settings.setObjectName("scrollArea_taxa_func_link_net_plot_settings")
        self.scrollAreaWidgetContents_8 = QtWidgets.QWidget()
        self.scrollAreaWidgetContents_8.setGeometry(QtCore.QRect(0, 0, 563, 95))
        ...
        self.scrollArea_taxa_func_link_net_plot_settings.setWidget(self.scrollAreaWidgetContents_8)
        self.gridLayout_6.addWidget(self.scrollArea_taxa_func_link_net_plot_settings, 10, 0, 1, 4)
        ...
        self.comboBox_pep_direct_to_otf_peptide_col_name = QtWidgets.QComboBox(self.tab_6)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.MinimumExpanding, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.comboBox_pep_direct_to_otf_peptide_col_name.sizePolicy().hasHeightForWidth())
        self.comboBox_pep_direct_to_otf_peptide_col_name.setSizePolicy(sizePolicy)
        self.comboBox_pep_direct_to_otf_peptide_col_name.setEditable(True)
        self.comboBox_pep_direct_to_otf_peptide_col_name.setObjectName("comboBox_pep_direct_to_otf_peptide_col_name")
        self.comboBox_pep_direct_to_otf_peptide_col_name.addItem("")
        self.comboBox_pep_direct_to_otf_peptide_col_name.addItem("")
        self.gridLayout_78.addWidget(self.comboBox_pep_direct_to_otf_peptide_col_name, 0, 1, 1, 1)
        self.comboBox_pep_direct_to_otf_intensity_column = QtWidgets.QComboBox(self.tab_6)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.MinimumExpanding, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.comboBox_pep_direct_to_otf_intensity_column.sizePolicy().hasHeightForWidth())
        self.comboBox_pep_direct_to_otf_intensity_column.setSizePolicy(sizePolicy)
        self.comboBox_pep_direct_to_otf_intensity_column.setEditable(True)
        self.comboBox_pep_direct_to_otf_intensity_column.setObjectName("comboBox_pep_direct_to_otf_intensity_column")
        self.comboBox_pep_direct_to_otf_intensity_column.addItem("")
        self.gridLayout_78.addWidget(self.comboBox_pep_direct_to_otf_intensity_column, 0, 3, 1, 1)
        self.gridLayout_74.addLayout(self.gridLayout_78, 7, 2, 1, 1)
        self.scrollArea_pep_direct_to_otf_settings = QtWidgets.QScrollArea(self.tab_6)
        self.scrollArea_pep_direct_to_otf_settings.setWidgetResizable(True)
        self.scrollArea_pep_direct_to_otf_settings.setObjectName("scrollArea_pep_direct_to_otf_settings")
        self.scrollAreaWidgetContents_11 = QtWidgets.QWidget()
        self.scrollAreaWidgetContents_11.setGeometry(QtCore.QRect(0, 0, 985, 295))
        self.scrollAreaWidgetContents_11.setObjectName("scrollAreaWidgetContents_11")
        self.gridLayout_40 = QtWidgets.QGridLayout(self.scrollAreaWidgetContents_11)
        self.gridLayout_40.setObjectName("gridLayout_40")
        self.gridLayout_76 = QtWidgets.QGridLayout()
        self.gridLayout_76.setObjectName("gridLayout_76")
        self.label_225 = QtWidgets.QLabel(self.scrollAreaWidgetContents_11)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.gridLayout_76.addWidget(self.label_225, 0, 0, 1, 1)
        self.label_231 = QtWidgets.QLabel(self.scrollAreaWidgetContents_11)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Maximum, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.gridLayout_76.addWidget(self.label_231, 1, 2, 1, 1)
        self.lineEdit_pep_direct_to_otf_genome_separator = QtWidgets.QLineEdit(self.scrollAreaWidgetContents_11)
        self.lineEdit_pep_direct_to_otf_genome_separator.setObjectName("lineEdit_pep_direct_to_otf_genome_separator")
        self.gridLayout_76.addWidget(self.lineEdit_pep_direct_to_otf_genome_separator, 0, 3, 1, 1)
        self.line_34 = QtWidgets.QFrame(self.scrollAreaWidgetContents_11)
        ...
        self.gridLayout_76.addWidget(self.line_34, 6, 0, 1, 4)
        self.lineEdit_pep_direct_to_otf_pep_table_sep = QtWidgets.QLineEdit(self.scrollAreaWidgetContents_11)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.lineEdit_pep_direct_to_otf_pep_table_sep.sizePolicy().hasHeightForWidth())
        self.lineEdit_pep_direct_to_otf_pep_table_sep.setSizePolicy(sizePolicy)
        self.lineEdit_pep_direct_to_otf_pep_table_sep.setObjectName("lineEdit_pep_direct_to_otf_pep_table_sep")
        self.gridLayout_76.addWidget(self.lineEdit_pep_direct_to_otf_pep_table_sep, 0, 1, 1, 1)
        self.label_245 = QtWidgets.QLabel(self.scrollAreaWidgetContents_11)
        self.label_245.setObjectName("label_245")
        self.gridLayout_76.addWidget(self.label_245, 2, 2, 1, 1)
        self.doubleSpinBox_pep_direct_to_otf_protein_coverage_cutoff = QtWidgets.QDoubleSpinBox(self.scrollAreaWidgetContents_11)
        ...
        self.gridLayout_76.addWidget(self.doubleSpinBox_pep_direct_to_otf_protein_coverage_cutoff, 3, 1, 1, 1)
        self.label_246 = QtWidgets.QLabel(self.scrollAreaWidgetContents_11)
        font = QtGui.QFont()
        font.setBold(True)
        font.setWeight(75)
        self.label_246.setFont(font)
        self.label_246.setObjectName("label_246")
        self.gridLayout_76.addWidget(self.label_246, 7, 0, 1, 1)
        self.lineEdit_pep_direct_to_otf_metaumbra_peptide_score_col = QtWidgets.QLineEdit(self.scrollAreaWidgetContents_11)
        self.lineEdit_pep_direct_to_otf_metaumbra_peptide_score_col.setObjectName("lineEdit_pep_direct_to_otf_metaumbra_peptide_score_col")
        self.gridLayout_76.addWidget(self.lineEdit_pep_direct_to_otf_metaumbra_peptide_score_col, 1, 3, 1, 1)
        self.label_248 = QtWidgets.QLabel(self.scrollAreaWidgetContents_11)
        self.label_248.setObjectName("label_248")
        self.gridLayout_76.addWidget(self.label_248, 1, 0, 1, 1)
        self.pushButton_pep_direct_to_otf_open_window_paste_gnome_list = QtWidgets.QPushButton(self.scrollAreaWidgetContents_11)
        self.pushButton_pep_direct_to_otf_open_window_paste_gnome_list.setEnabled(False)
        self.pushButton_pep_direct_to_otf_open_window_paste_gnome_list.setObjectName("pushButton_pep_direct_to_otf_open_window_paste_gnome_list")
        self.gridLayout_76.addWidget(self.pushButton_pep_direct_to_otf_open_window_paste_gnome_list, 4, 2, 1, 1)
        self.label_228 = QtWidgets.QLabel(self.scrollAreaWidgetContents_11)
        self.label_228.setObjectName("label_228")
        self.gridLayout_76.addWidget(self.label_228, 2, 0, 1, 1)
        self.horizontalLayout_135 = QtWidgets.QHBoxLayout()
        self.horizontalLayout_135.setObjectName("horizontalLayout_135")
        self.label__pep_direct_to_otf_selected_genome_num = QtWidgets.QLabel(self.scrollAreaWidgetContents_11)
        self.label__pep_direct_to_otf_selected_genome_num.setEnabled(False)
        self.label__pep_direct_to_otf_selected_genome_num.setObjectName("label__pep_direct_to_otf_selected_genome_num")
        self.horizontalLayout_135.addWidget(self.label__pep_direct_to_otf_selected_genome_num)
        self.pushButton_pep_direct_to_otf_reset_selected_genome_list = QtWidgets.QPushButton(self.scrollAreaWidgetContents_11)
        self.pushButton_pep_direct_to_otf_reset_selected_genome_list.setEnabled(False)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.pushButton_pep_direct_to_otf_reset_selected_genome_list.sizePolicy().hasHeightForWidth())
        self.pushButton_pep_direct_to_otf_reset_selected_genome_list.setSizePolicy(sizePolicy)
        self.pushButton_pep_direct_to_otf_reset_selected_genome_list.setMinimumSize(QtCore.QSize(0, 0))
        self.pushButton_pep_direct_to_otf_reset_selected_genome_list.setMaximumSize(QtCore.QSize(50, 16777215))
        self.pushButton_pep_direct_to_otf_reset_selected_genome_list.setObjectName("pushButton_pep_direct_to_otf_reset_selected_genome_list")
        self.horizontalLayout_135.addWidget(self.pushButton_pep_direct_to_otf_reset_selected_genome_list)
        self.gridLayout_76.addLayout(self.horizontalLayout_135, 4, 3, 1, 1)
        self.pushButton_pep_direct_to_otf_open_genome_list_file = QtWidgets.QPushButton(self.scrollAreaWidgetContents_11)
        self.pushButton_pep_direct_to_otf_open_genome_list_file.setEnabled(False)
        self.pushButton_pep_direct_to_otf_open_genome_list_file.setObjectName("pushButton_pep_direct_to_otf_open_genome_list_file")
        self.gridLayout_76.addWidget(self.pushButton_pep_direct_to_otf_open_genome_list_file, 4, 1, 1, 1)
        self.checkBox_pep_direct_to_otf_use_selected_genome_list = QtWidgets.QCheckBox(self.scrollAreaWidgetContents_11)
        self.checkBox_pep_direct_to_otf_use_selected_genome_list.setObjectName("checkBox_pep_direct_to_otf_use_selected_genome_list")
        self.gridLayout_76.addWidget(self.checkBox_pep_direct_to_otf_use_selected_genome_list, 4, 0, 1, 1)
        self.label_232 = QtWidgets.QLabel(self.scrollAreaWidgetContents_11)
        self.label_232.setObjectName("label_232")
        self.gridLayout_76.addWidget(self.label_232, 3, 0, 1, 1)
        self.lineEdit_pep_direct_to_otf_metaumbra_peptide_error_col = QtWidgets.QLineEdit(self.scrollAreaWidgetContents_11)
        self.lineEdit_pep_direct_to_otf_metaumbra_peptide_error_col.setObjectName("lineEdit_pep_direct_to_otf_metaumbra_peptide_error_col")
        self.gridLayout_76.addWidget(self.lineEdit_pep_direct_to_otf_metaumbra_peptide_error_col, 1, 1, 1, 1)
        self.label_230 = QtWidgets.QLabel(self.scrollAreaWidgetContents_11)
        self.label_230.setObjectName("label_230")
        self.gridLayout_76.addWidget(self.label_230, 7, 1, 1, 1)
        self.doubleSpinBox_pep_direct_to_otf_metaumbra_qvalue_cutoff = QtWidgets.QDoubleSpinBox(self.scrollAreaWidgetContents_11)
        self.doubleSpinBox_pep_direct_to_otf_metaumbra_qvalue_cutoff.setFocusPolicy(QtCore.Qt.WheelFocus)
        self.doubleSpinBox_pep_direct_to_otf_metaumbra_qvalue_cutoff.setAccelerated(False)
        self.doubleSpinBox_pep_direct_to_otf_metaumbra_qvalue_cutoff.setDecimals(3)
        self.doubleSpinBox_pep_direct_to_otf_metaumbra_qvalue_cutoff.setMinimum(0.001)
        self.doubleSpinBox_pep_direct_to_otf_metaumbra_qvalue_cutoff.setMaximum(1.0)
        self.doubleSpinBox_pep_direct_to_otf_metaumbra_qvalue_cutoff.setSingleStep(0.01)
        self.doubleSpinBox_pep_direct_to_otf_metaumbra_qvalue_cutoff.setProperty("value", 0.05)
        self.doubleSpinBox_pep_direct_to_otf_metaumbra_qvalue_cutoff.setObjectName("doubleSpinBox_pep_direct_to_otf_metaumbra_qvalue_cutoff")
        self.gridLayout_76.addWidget(self.doubleSpinBox_pep_direct_to_otf_metaumbra_qvalue_cutoff, 2, 3, 1, 1)
        self.label_229 = QtWidgets.QLabel(self.scrollAreaWidgetContents_11)
        self.label_229.setObjectName("label_229")
        self.gridLayout_76.addWidget(self.label_229, 0, 2, 1, 1)
        self.doubleSpinBox_pep_direct_to_otf_LCA_threshold = QtWidgets.QDoubleSpinBox(self.scrollAreaWidgetContents_11)
        ...
        self.gridLayout_76.addWidget(self.doubleSpinBox_pep_direct_to_otf_LCA_threshold, 7, 2, 1, 1)
        self.checkBox_pep_direct_to_otf_stop_after_metaumbra = QtWidgets.QCheckBox(self.scrollAreaWidgetContents_11)
        self.checkBox_pep_direct_to_otf_stop_after_metaumbra.setObjectName("checkBox_pep_direct_to_otf_stop_after_metaumbra")
        self.gridLayout_76.addWidget(self.checkBox_pep_direct_to_otf_stop_after_metaumbra, 3, 2, 1, 2)
        self.doubleSpinBox_pep_direct_to_otf_metaumbra_single_peptide_error = QtWidgets.QDoubleSpinBox(self.scrollAreaWidgetContents_11)
        self.doubleSpinBox_pep_direct_to_otf_metaumbra_single_peptide_error.setDecimals(2)
        self.doubleSpinBox_pep_direct_to_otf_metaumbra_single_peptide_error.setMinimum(0.01)
        self.doubleSpinBox_pep_direct_to_otf_metaumbra_single_peptide_error.setMaximum(1.0)
        self.doubleSpinBox_pep_direct_to_otf_metaumbra_single_peptide_error.setSingleStep(0.05)
        self.doubleSpinBox_pep_direct_to_otf_metaumbra_single_peptide_error.setProperty("value", 0.3)
        self.doubleSpinBox_pep_direct_to_otf_metaumbra_single_peptide_error.setObjectName("doubleSpinBox_pep_direct_to_otf_metaumbra_single_peptide_error")
        self.gridLayout_76.addWidget(self.doubleSpinBox_pep_direct_to_otf_metaumbra_single_peptide_error, 2, 1, 1, 1)
        self.label_249 = QtWidgets.QLabel(self.scrollAreaWidgetContents_11)
        self.label_249.setObjectName("label_249")
        self.gridLayout_76.addWidget(self.label_249, 5, 0, 1, 1)
        self.comboBox_pep_direct_to_otf_duplicate_peptide_handle_mode = QtWidgets.QComboBox(self.scrollAreaWidgetContents_11)
        self.comboBox_pep_direct_to_otf_duplicate_peptide_handle_mode.setObjectName("comboBox_pep_direct_to_otf_duplicate_peptide_handle_mode")
        self.comboBox_pep_direct_to_otf_duplicate_peptide_handle_mode.addItem("")
        self.comboBox_pep_direct_to_otf_duplicate_peptide_handle_mode.addItem("")
        self.comboBox_pep_direct_to_otf_duplicate_peptide_handle_mode.addItem("")
        self.comboBox_pep_direct_to_otf_duplicate_peptide_handle_mode.addItem("")
        self.comboBox_pep_direct_to_otf_duplicate_peptide_handle_mode.addItem("")
        self.gridLayout_76.addWidget(self.comboBox_pep_direct_to_otf_duplicate_peptide_handle_mode, 5, 1, 1, 1)
        self.gridLayout_40.addLayout(self.gridLayout_76, 0, 0, 1, 1)
        self.scrollArea_pep_direct_to_otf_settings.setWidget(self.scrollAreaWidgetContents_11)
        self.gridLayout_74.addWidget(self.scrollArea_pep_direct_to_otf_settings, 9, 0, 1, 4)
        self.checkBox_pep_direct_to_otf_use_unit_specific_annotate = QtWidgets.QCheckBox(self.tab_6)
        self.checkBox_pep_direct_to_otf_use_unit_specific_annotate.setObjectName("checkBox_pep_direct_to_otf_use_unit_specific_annotate")
        self.gridLayout_74.addWidget(self.checkBox_pep_direct_to_otf_use_unit_specific_annotate, 5, 0, 1, 1)
        self.pushButton_pep_direct_to_otf_open_metaumbra_gui = QtWidgets.QPushButton(self.tab_6)
        self.pushButton_pep_direct_to_otf_open_metaumbra_gui.setObjectName("pushButton_pep_direct_to_otf_open_metaumbra_gui")
        self.gridLayout_74.addWidget(self.pushButton_pep_direct_to_otf_open_metaumbra_gui, 7, 0, 1, 1)
        ...
        self.lineEdit_pep_direct_to_otf_unit_specific_manifest_path = QtWidgets.QLineEdit(self.tab_6)
        self.lineEdit_pep_direct_to_otf_unit_specific_manifest_path.setEnabled(False)
        self.lineEdit_pep_direct_to_otf_unit_specific_manifest_path.setObjectName("lineEdit_pep_direct_to_otf_unit_specific_manifest_path")
        self.gridLayout_74.addWidget(self.lineEdit_pep_direct_to_otf_unit_specific_manifest_path, 6, 2, 1, 1)
        ...
        self.gridLayout_74.addWidget(self.pushButton_run_pep_direct_to_otf, 10, 0, 1, 4)
        ...
        self.label_unit_specific_manifest = QtWidgets.QLabel(self.tab_6)
        self.label_unit_specific_manifest.setObjectName("label_unit_specific_manifest")
        self.gridLayout_74.addWidget(self.label_unit_specific_manifest, 6, 0, 1, 1)
        self.lineEdit_pep_direct_to_otf_digestied_genome_pep_path = QtWidgets.QLineEdit(self.tab_6)
        self.lineEdit_pep_direct_to_otf_digestied_genome_pep_path.setToolTip("")
        self.lineEdit_pep_direct_to_otf_digestied_genome_pep_path.setObjectName("lineEdit_pep_direct_to_otf_digestied_genome_pep_path")
        self.gridLayout_74.addWidget(self.lineEdit_pep_direct_to_otf_digestied_genome_pep_path, 1, 2, 1, 1)
        self.checkBox_8 = QtWidgets.QCheckBox(self.tab_6)
        self.checkBox_8.setChecked(False)
        self.checkBox_8.setObjectName("checkBox_8")
        self.gridLayout_74.addWidget(self.checkBox_8, 8, 0, 1, 1)
        ...
        self.pushButton_open_pep_direct_to_otf_unit_specific_manifest_path = QtWidgets.QPushButton(self.tab_6)
        self.pushButton_open_pep_direct_to_otf_unit_specific_manifest_path.setEnabled(False)
        self.pushButton_open_pep_direct_to_otf_unit_specific_manifest_path.setObjectName("pushButton_open_pep_direct_to_otf_unit_specific_manifest_path")
        self.gridLayout_74.addWidget(self.pushButton_open_pep_direct_to_otf_unit_specific_manifest_path, 6, 3, 1, 1)
        self.horizontalLayout_140 = QtWidgets.QHBoxLayout()
        self.horizontalLayout_140.setObjectName("horizontalLayout_140")
        self.pushButton_pep_direct_to_otf_unit_specific_settings = QtWidgets.QPushButton(self.tab_6)
        self.pushButton_pep_direct_to_otf_unit_specific_settings.setEnabled(False)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.pushButton_pep_direct_to_otf_unit_specific_settings.sizePolicy().hasHeightForWidth())
        self.pushButton_pep_direct_to_otf_unit_specific_settings.setSizePolicy(sizePolicy)
        self.pushButton_pep_direct_to_otf_unit_specific_settings.setObjectName("pushButton_pep_direct_to_otf_unit_specific_settings")
        self.horizontalLayout_140.addWidget(self.pushButton_pep_direct_to_otf_unit_specific_settings)
        self.label_pep_direct_to_otf_use_unit_specific_genome_threshold = QtWidgets.QLabel(self.tab_6)
        self.label_pep_direct_to_otf_use_unit_specific_genome_threshold.setEnabled(False)
        self.label_pep_direct_to_otf_use_unit_specific_genome_threshold.setAlignment(QtCore.Qt.AlignRight|QtCore.Qt.AlignTrailing|QtCore.Qt.AlignVCenter)
        self.label_pep_direct_to_otf_use_unit_specific_genome_threshold.setObjectName("label_pep_direct_to_otf_use_unit_specific_genome_threshold")
        self.horizontalLayout_140.addWidget(self.label_pep_direct_to_otf_use_unit_specific_genome_threshold)
        self.comboBox_pep_direct_to_otf_use_unit_specific_genome_threshold = QtWidgets.QComboBox(self.tab_6)
        self.comboBox_pep_direct_to_otf_use_unit_specific_genome_threshold.setEnabled(False)
        self.comboBox_pep_direct_to_otf_use_unit_specific_genome_threshold.setObjectName("comboBox_pep_direct_to_otf_use_unit_specific_genome_threshold")
        self.comboBox_pep_direct_to_otf_use_unit_specific_genome_threshold.addItem("")
        self.comboBox_pep_direct_to_otf_use_unit_specific_genome_threshold.addItem("")
        self.horizontalLayout_140.addWidget(self.comboBox_pep_direct_to_otf_use_unit_specific_genome_threshold)
        self.gridLayout_74.addLayout(self.horizontalLayout_140, 5, 2, 1, 1)
        ...
        self.scrollArea_peptide_annotator_settings = QtWidgets.QScrollArea(self.tab_17)
        self.scrollArea_peptide_annotator_settings.setWidgetResizable(True)
        self.scrollArea_peptide_annotator_settings.setObjectName("scrollArea_peptide_annotator_settings")
        self.scrollAreaWidgetContents_9 = QtWidgets.QWidget()
        self.scrollAreaWidgetContents_9.setGeometry(QtCore.QRect(0, 0, 1050, 198))
        self.scrollAreaWidgetContents_9.setObjectName("scrollAreaWidgetContents_9")
        self.gridLayout_15 = QtWidgets.QGridLayout(self.scrollAreaWidgetContents_9)
        self.gridLayout_15.setObjectName("gridLayout_15")
        self.gridLayout_35 = QtWidgets.QGridLayout()
        self.gridLayout_35.setObjectName("gridLayout_35")
        self.label_200 = QtWidgets.QLabel(self.scrollAreaWidgetContents_9)
        self.label_200.setObjectName("label_200")
        self.gridLayout_35.addWidget(self.label_200, 2, 0, 1, 1)
        self.label_199 = QtWidgets.QLabel(self.scrollAreaWidgetContents_9)
        self.label_199.setObjectName("label_199")
        self.gridLayout_35.addWidget(self.label_199, 1, 0, 1, 1)
        self.checkBox_annotator_genome_mode = QtWidgets.QCheckBox(self.scrollAreaWidgetContents_9)
        ...
        self.label_202 = QtWidgets.QLabel(self.scrollAreaWidgetContents_9)
        self.label_202.setObjectName("label_202")
        self.gridLayout_35.addWidget(self.label_202, 2, 2, 1, 1)
        self.lineEdit_annotator_sample_col_prefix = QtWidgets.QLineEdit(self.scrollAreaWidgetContents_9)
        self.lineEdit_annotator_sample_col_prefix.setToolTip("")
        ...
        self.lineEdit_annotator_exclude_protein_startwith = QtWidgets.QLineEdit(self.scrollAreaWidgetContents_9)
        ...
        self.spinBox_annotator_distinct_num_threshold = QtWidgets.QSpinBox(self.scrollAreaWidgetContents_9)
        ...
        self.label_204 = QtWidgets.QLabel(self.scrollAreaWidgetContents_9)
        self.label_204.setObjectName("label_204")
        self.gridLayout_35.addWidget(self.label_204, 0, 0, 1, 1)
        self.lineEdit_annotator_protein_separator = QtWidgets.QLineEdit(self.scrollAreaWidgetContents_9)
        ...
        self.lineEdit_annotator_genome_separator = QtWidgets.QLineEdit(self.scrollAreaWidgetContents_9)
        ...
        self.gridLayout_35.addWidget(self.label_244, 4, 0, 1, 1)
        self.label_205 = QtWidgets.QLabel(self.scrollAreaWidgetContents_9)
        self.label_205.setObjectName("label_205")
        self.gridLayout_35.addWidget(self.label_205, 3, 2, 1, 1)
        self.label_201 = QtWidgets.QLabel(self.scrollAreaWidgetContents_9)
        self.label_201.setObjectName("label_201")
        self.gridLayout_35.addWidget(self.label_201, 1, 2, 1, 1)
        self.comboBox_annotator_duplicate_peptide_handle_mode = QtWidgets.QComboBox(self.scrollAreaWidgetContents_9)
        self.comboBox_annotator_duplicate_peptide_handle_mode.setObjectName("comboBox_annotator_duplicate_peptide_handle_mode")
        self.comboBox_annotator_duplicate_peptide_handle_mode.addItem("")
        self.comboBox_annotator_duplicate_peptide_handle_mode.addItem("")
        self.comboBox_annotator_duplicate_peptide_handle_mode.addItem("")
        self.comboBox_annotator_duplicate_peptide_handle_mode.addItem("")
        self.comboBox_annotator_duplicate_peptide_handle_mode.addItem("")
        self.gridLayout_35.addWidget(self.comboBox_annotator_duplicate_peptide_handle_mode, 4, 1, 1, 1)
        self.label_203 = QtWidgets.QLabel(self.scrollAreaWidgetContents_9)
        self.label_203.setObjectName("label_203")
        self.gridLayout_35.addWidget(self.label_203, 3, 0, 1, 1)
        self.comboBox_annotator_peptide_col_name = QtWidgets.QComboBox(self.scrollAreaWidgetContents_9)
        self.comboBox_annotator_peptide_col_name.setEditable(True)
        self.comboBox_annotator_peptide_col_name.setObjectName("comboBox_annotator_peptide_col_name")
        self.comboBox_annotator_peptide_col_name.addItem("")
        self.comboBox_annotator_peptide_col_name.addItem("")
        self.gridLayout_35.addWidget(self.comboBox_annotator_peptide_col_name, 2, 1, 1, 1)
        self.comboBox_annotator_protein_col_name = QtWidgets.QComboBox(self.scrollAreaWidgetContents_9)
        self.comboBox_annotator_protein_col_name.setEditable(True)
        self.comboBox_annotator_protein_col_name.setObjectName("comboBox_annotator_protein_col_name")
        self.comboBox_annotator_protein_col_name.addItem("")
        self.comboBox_annotator_protein_col_name.addItem("")
        self.gridLayout_35.addWidget(self.comboBox_annotator_protein_col_name, 2, 3, 1, 1)
        self.gridLayout_15.addLayout(self.gridLayout_35, 0, 0, 1, 1)
        self.scrollArea_peptide_annotator_settings.setWidget(self.scrollAreaWidgetContents_9)
        self.gridLayout_42.addWidget(self.scrollArea_peptide_annotator_settings, 5, 0, 1, 4)
        ...
        self.page_3.setGeometry(QtCore.QRect(0, 0, 452, 60))
        ...
        self.page_4.setGeometry(QtCore.QRect(0, 0, 373, 189))
        ...
        self.checkBox_pep_direct_to_otf_stop_after_metaumbra.toggled['bool'].connect(self.lineEdit_pep_direct_to_otf_pro2taxafunc_db_path.setDisabled) # type: ignore
        ...
        self.checkBox_show_mroe_options_of_set_otf.toggled['bool'].connect(self.scrollArea_set_otf_options.setVisible) # type: ignore
        self.checkBox_show_basic_plot_settings.toggled['bool'].connect(self.scrollArea_basic_plot_settings.setVisible) # type: ignore
        self.checkBox.toggled['bool'].connect(self.scrollArea_basic_heatmap_plot_settings.setVisible) # type: ignore
        self.checkBox_2.toggled['bool'].connect(self.scrollArea_cross_heatmap_settings.setVisible) # type: ignore
        self.checkBox_3.toggled['bool'].connect(self.scrollArea_deseq2_plot_settings.setVisible) # type: ignore
        self.checkBox_4.toggled['bool'].connect(self.scrollArea_co_expression_plot_settings.setVisible) # type: ignore
        self.checkBox_5.toggled['bool'].connect(self.scrollArea_expression_trends_plot_settings.setVisible) # type: ignore
        self.checkBox_6.toggled['bool'].connect(self.scrollArea_taxa_func_link_plot_settings.setVisible) # type: ignore
        self.checkBox_7.toggled['bool'].connect(self.scrollArea_taxa_func_link_net_plot_settings.setVisible) # type: ignore
        self.checkBox_show_advanced_annotator_settings.toggled['bool'].connect(self.scrollArea_peptide_annotator_settings.setVisible) # type: ignore
        self.checkBox_8.toggled['bool'].connect(self.scrollArea_pep_direct_to_otf_settings.setVisible) # type: ignore
        self.checkBox_pep_direct_to_otf_stop_after_metaumbra.toggled['bool'].connect(self.doubleSpinBox_pep_direct_to_otf_protein_coverage_cutoff.setDisabled) # type: ignore
        self.checkBox_pep_direct_to_otf_stop_after_metaumbra.toggled['bool'].connect(self.doubleSpinBox_pep_direct_to_otf_LCA_threshold.setDisabled) # type: ignore
        self.checkBox_pep_direct_to_otf_stop_after_metaumbra.toggled['bool'].connect(self.checkBox_pep_direct_to_otf_use_selected_genome_list.setDisabled) # type: ignore
        self.checkBox_pep_direct_to_otf_use_selected_genome_list.toggled['bool'].connect(self.pushButton_pep_direct_to_otf_open_genome_list_file.setEnabled) # type: ignore
        self.checkBox_pep_direct_to_otf_use_selected_genome_list.toggled['bool'].connect(self.pushButton_pep_direct_to_otf_open_window_paste_gnome_list.setEnabled) # type: ignore
        self.checkBox_pep_direct_to_otf_use_selected_genome_list.toggled['bool'].connect(self.label__pep_direct_to_otf_selected_genome_num.setEnabled) # type: ignore
        self.checkBox_pep_direct_to_otf_use_selected_genome_list.toggled['bool'].connect(self.lineEdit_pep_direct_to_otf_metaumbra_peptide_error_col.setDisabled) # type: ignore
        self.checkBox_pep_direct_to_otf_use_selected_genome_list.toggled['bool'].connect(self.lineEdit_pep_direct_to_otf_metaumbra_peptide_score_col.setDisabled) # type: ignore
        self.checkBox_pep_direct_to_otf_use_selected_genome_list.toggled['bool'].connect(self.doubleSpinBox_pep_direct_to_otf_metaumbra_single_peptide_error.setDisabled) # type: ignore
        self.checkBox_pep_direct_to_otf_use_selected_genome_list.toggled['bool'].connect(self.checkBox_pep_direct_to_otf_stop_after_metaumbra.setDisabled) # type: ignore
        self.checkBox_pep_direct_to_otf_use_selected_genome_list.toggled['bool'].connect(self.pushButton_pep_direct_to_otf_reset_selected_genome_list.setEnabled) # type: ignore
        self.checkBox_pep_direct_to_otf_stop_after_metaumbra.toggled['bool'].connect(self.comboBox_pep_direct_to_otf_duplicate_peptide_handle_mode.setDisabled) # type: ignore
        self.checkBox_pep_direct_to_otf_use_unit_specific_annotate.toggled['bool'].connect(self.pushButton_pep_direct_to_otf_unit_specific_settings.setEnabled) # type: ignore
        self.checkBox_pep_direct_to_otf_use_unit_specific_annotate.toggled['bool'].connect(self.lineEdit_pep_direct_to_otf_unit_specific_manifest_path.setEnabled) # type: ignore
        self.checkBox_pep_direct_to_otf_use_unit_specific_annotate.toggled['bool'].connect(self.pushButton_open_pep_direct_to_otf_unit_specific_manifest_path.setEnabled) # type: ignore
        self.checkBox_pep_direct_to_otf_use_unit_specific_annotate.toggled['bool'].connect(self.label_pep_direct_to_otf_use_unit_specific_genome_threshold.setEnabled) # type: ignore
        self.checkBox_pep_direct_to_otf_use_unit_specific_annotate.toggled['bool'].connect(self.comboBox_pep_direct_to_otf_use_unit_specific_genome_threshold.setEnabled) # type: ignore
    ...
    def retranslateUi(self, metaX_main):
        ...
        self.pushButton_generate_report.setText(_translate("metaX_main", "Generate Report"))
        ...
        self.comboBox_outlier_detection.setItemText(5, _translate("metaX_main", "Intensity-Percentile"))
        self.comboBox_outlier_detection.setItemText(6, _translate("metaX_main", "Z-Score"))
        self.comboBox_outlier_detection.setItemText(7, _translate("metaX_main", "Mahalanobis-Distance"))
        self.comboBox_outlier_detection.setItemText(8, _translate("metaX_main", "Zero-Inflated-Poisson"))
        self.comboBox_outlier_detection.setItemText(9, _translate("metaX_main", "Negative-Binomial"))
        self.label_outlier_intensity_percentile_threshold.setText(_translate("metaX_main", "Low intensity percentile threshold (%)"))
        self.doubleSpinBox_outlier_intensity_percentile_threshold.setStatusTip(_translate("metaX_main", "Intensity values below this threshold will be considered outliers"))
        ...
        self.label_128.setText(_translate("metaX_main", "Minimum Peptide Number Threshold"))
        ...
        self.checkBox_show_mroe_options_of_set_otf.setText(_translate("metaX_main", "Show More Options"))
        self.label_241.setText(_translate("metaX_main", "Function:"))
        ...
        self.checkBox_set_taxa_func_split_func_share_intensity.setText(_translate("metaX_main", "Share intensity between split functions"))
        self.checkBox_set_taxa_func_split_func.setToolTip(_translate("metaX_main", "Split items that contain multiple functions"))
        self.checkBox_set_taxa_func_split_func.setText(_translate("metaX_main", "Split function terms by"))
        self.label_243.setText(_translate("metaX_main", "OTFS:"))
        self.checkBox_set_otf_remove_unknown_taxa.setText(_translate("metaX_main", "Remove unknown taxa"))
        self.label_242.setText(_translate("metaX_main", "Taxa:"))
        self.checkBox_create_protein_table.setText(_translate("metaX_main", "Generate protein intensity table"))
        ...
        self.checkBox_set_otf_taxa_and_func_only_from_otf.setText(_translate("metaX_main", "Create taxa and functions based only on OTFs"))
        self.label_24.setText(_translate("metaX_main", "Minimum peptide number per protein"))
        ...
        self.checkBox_infrence_protein_by_sample.setText(_translate("metaX_main", "Perform inference per sample"))
        ...
        self.pushButton_basic_items_pca_plot.setText(_translate("metaX_main", "Plot PCA"))
        ...
        self.pushButton_basic_heatmap_metatree.setText(_translate("metaX_main", "MetaTree"))
        ...
        self.label_250.setText(_translate("metaX_main", "PCA"))
        self.checkBox_basic_items_pca_show_labels.setText(_translate("metaX_main", "Show Labels"))
        self.checkBox_basic_items_pca_js.setText(_translate("metaX_main", "3D PCA"))
        ...
        self.tabWidget_4.setTabText(self.tabWidget_4.indexOf(self.tab_13), _translate("metaX_main", "Items Plot"))
        ...
        self.checkBox_comparing_group_control_in_condition.setText(_translate("metaX_main", "Comparing in Each Condition by"))
        self.label_140.setText(_translate("metaX_main", "Covariates for model:"))
        ...
        self.label_251.setText(_translate("metaX_main", "Method:"))
        self.comboBox_multi_de_method.setItemText(0, _translate("metaX_main", "Limma"))
        self.comboBox_multi_de_method.setItemText(1, _translate("metaX_main", "Deseq2"))
        self.comboBox_multi_de_method.setItemText(2, _translate("metaX_main", "Dunnett\'s"))
        self.checkBox_multi_de_convert_zero_to_nan_before_limma.setText(_translate("metaX_main", "Convert zeros to NaN"))
        self.pushButton_run_multi_de.setText(_translate("metaX_main", "Run"))
        ...
        self.label_247.setText(_translate("metaX_main", "Covariates"))
        ...
        self.label_252.setText(_translate("metaX_main", "Method:"))
        self.comboBox_de_method.setItemText(0, _translate("metaX_main", "Limma"))
        self.comboBox_de_method.setItemText(1, _translate("metaX_main", "DESeq2"))
        self.checkBox_de_convert_zero_to_nan_before_limma.setToolTip(_translate("metaX_main", "Convert zeros to NaN before limma runs"))
        self.checkBox_de_convert_zero_to_nan_before_limma.setText(_translate("metaX_main", "Convert zeros to NaN"))
        self.pushButton_run_de.setText(_translate("metaX_main", "Run"))
        self.tabWidget_3.setTabText(self.tabWidget_3.indexOf(self.tab_19), _translate("metaX_main", "Differential Expression"))
...
""))
        ...
        self.comboBox_pep_direct_to_otf_peptide_col_name.setItemText(0, _translate("metaX_main", "Stripped.Sequence"))
        self.comboBox_pep_direct_to_otf_peptide_col_name.setItemText(1, _translate("metaX_main", "Sequence"))
        self.comboBox_pep_direct_to_otf_intensity_column.setToolTip(_translate("metaX_main", "e.g. \"Intensity\" in Intensity_V2_05, Intensity_V2_06"))
        self.comboBox_pep_direct_to_otf_intensity_column.setStatusTip(_translate("metaX_main", "e.g. \"Intensity\" in Intensity_V2_05, Intensity_V2_06 or may startwith Path like \"D:\\\""))
        self.comboBox_pep_direct_to_otf_intensity_column.setItemText(0, _translate("metaX_main", "Intensity"))
        self.label_225.setText(_translate("metaX_main", "Separator of Peptide Table"))
        self.label_231.setText(_translate("metaX_main", "Peptide score column(Optional)"))
        ...
        self.label_245.setText(_translate("metaX_main", "Genome q-value cutoff"))
        self.label_246.setText(_translate("metaX_main", "Peptide Annotate to Taxon:"))
        self.lineEdit_pep_direct_to_otf_metaumbra_peptide_score_col.setText(_translate("metaX_main", "score"))
        self.label_248.setText(_translate("metaX_main", "Peptide error column (Optional)"))
        self.pushButton_pep_direct_to_otf_open_window_paste_gnome_list.setStatusTip(_translate("metaX_main", "Paste one genome ID per line, or separated by comma/semicolon."))
        self.pushButton_pep_direct_to_otf_open_window_paste_gnome_list.setText(_translate("metaX_main", "Paste Genome List"))
        self.label_228.setText(_translate("metaX_main", "Single peptide error upper bound"))
        self.label__pep_direct_to_otf_selected_genome_num.setStatusTip(_translate("metaX_main", "Number of genomes currently loaded from the selected genome list."))
        self.label__pep_direct_to_otf_selected_genome_num.setText(_translate("metaX_main", "Selected genomes: 0"))
        self.pushButton_pep_direct_to_otf_reset_selected_genome_list.setStatusTip(_translate("metaX_main", "Reset the selected genome list"))
        self.pushButton_pep_direct_to_otf_reset_selected_genome_list.setText(_translate("metaX_main", "🔄"))
        self.pushButton_pep_direct_to_otf_open_genome_list_file.setStatusTip(_translate("metaX_main", "Accepts either a plain genome ID list or a MetaUmbra genome_presence.tsv file."))
        self.pushButton_pep_direct_to_otf_open_genome_list_file.setText(_translate("metaX_main", "Open Genome List File"))
        self.checkBox_pep_direct_to_otf_use_selected_genome_list.setStatusTip(_translate("metaX_main", "Skip MetaUmbra genome scoring and continue OTF construction using a predefined genome list."))
        self.checkBox_pep_direct_to_otf_use_selected_genome_list.setText(_translate("metaX_main", "Use selected genome list"))
        self.label_232.setText(_translate("metaX_main", "Peptide Coverage Cutoff for Protein Selection"))
        self.lineEdit_pep_direct_to_otf_metaumbra_peptide_error_col.setText(_translate("metaX_main", "Q.Value"))
        self.label_230.setText(_translate("metaX_main", "LCA Threshold for OTF"))
        self.label_229.setText(_translate("metaX_main", "Genome Separator in Protein ID"))
        self.checkBox_pep_direct_to_otf_stop_after_metaumbra.setText(_translate("metaX_main", "Stop After MetaUmbra Scoring"))
        self.label_249.setText(_translate("metaX_main", "Method to handle duplicate peptides intensity"))
        self.comboBox_pep_direct_to_otf_duplicate_peptide_handle_mode.setItemText(0, _translate("metaX_main", "sum"))
        self.comboBox_pep_direct_to_otf_duplicate_peptide_handle_mode.setItemText(1, _translate("metaX_main", "max"))
        self.comboBox_pep_direct_to_otf_duplicate_peptide_handle_mode.setItemText(2, _translate("metaX_main", "min"))
        self.comboBox_pep_direct_to_otf_duplicate_peptide_handle_mode.setItemText(3, _translate("metaX_main", "mean"))
        self.comboBox_pep_direct_to_otf_duplicate_peptide_handle_mode.setItemText(4, _translate("metaX_main", "first"))
        self.checkBox_pep_direct_to_otf_use_unit_specific_annotate.setText(_translate("metaX_main", "Use unit-specific annotation"))
        self.pushButton_pep_direct_to_otf_open_metaumbra_gui.setStatusTip(_translate("metaX_main", "Open MetaUmbra GUI for more functions"))
        self.pushButton_pep_direct_to_otf_open_metaumbra_gui.setText(_translate("metaX_main", "Open MetaUmbra GUI"))
        self.label_222.setText(_translate("metaX_main", "Digested Genome Folder"))
        ...
        self.lineEdit_pep_direct_to_otf_output_path.setStatusTip(_translate("metaX_main", "The path for save the OTF result"))
        ...
        self.lineEdit_pep_direct_to_otf_peptide_path.setStatusTip(_translate("metaX_main", "Peptite table with intensity from search result(e.g. report.pr_matrix)"))
        ...
        self.label_unit_specific_manifest.setText(_translate("metaX_main", "MetaUmbra unit-specific manifest"))
        self.lineEdit_pep_direct_to_otf_digestied_genome_pep_path.setStatusTip(_translate("metaX_main", "The folder contains all the digested genome files, with each file containing protein-peptide information."))
        self.checkBox_8.setText(_translate("metaX_main", "Show Advanced Settings"))
        self.lineEdit_pep_direct_to_otf_pro2taxafunc_db_path.setStatusTip(_translate("metaX_main", "The databse file from Database builder of MetaX"))
        self.label_220.setText(_translate("metaX_main", "Peptide Table"))
        self.pushButton_open_pep_direct_to_otf_unit_specific_manifest_path.setText(_translate("metaX_main", "Open"))
        self.pushButton_pep_direct_to_otf_unit_specific_settings.setText(_translate("metaX_main", "Unit-specific Settings..."))
        self.label_pep_direct_to_otf_use_unit_specific_genome_threshold.setText(_translate("metaX_main", "Genome threshold"))
        self.comboBox_pep_direct_to_otf_use_unit_specific_genome_threshold.setItemText(0, _translate("metaX_main", "q0.05"))
        self.comboBox_pep_direct_to_otf_use_unit_specific_genome_threshold.setItemText(1, _translate("metaX_main", "q0.01"))
        self.tabWidget_6.setTabText(self.tabWidget_6.indexOf(self.tab_6), _translate("metaX_main", "Pepetide Direct to OTFs (MetaUmbra)"))
        ...
        self.lineEdit_annotator_sample_col_prefix.setStatusTip(_translate("metaX_main", "e.g. \"Intensity\" in Intensity_V2_05, Intensity_V2_06"))
        ...
        self.lineEdit_annotator_exclude_protein_startwith.setStatusTip(_translate("metaX_main", "e.g. REV_MGYG000000049_00365; HUMAN_XXXX"))
        ...
        self.label_244.setText(_translate("metaX_main", "Method to handle duplicate peptides intensity"))
        ...
        self.comboBox_annotator_duplicate_peptide_handle_mode.setItemText(0, _translate("metaX_main", "sum"))
        self.comboBox_annotator_duplicate_peptide_handle_mode.setItemText(1, _translate("metaX_main", "max"))
        self.comboBox_annotator_duplicate_peptide_handle_mode.setItemText(2, _translate("metaX_main", "min"))
        self.comboBox_annotator_duplicate_peptide_handle_mode.setItemText(3, _translate("metaX_main", "mean"))
        self.comboBox_annotator_duplicate_peptide_handle_mode.setItemText(4, _translate("metaX_main", "first"))
        self.label_203.setText(_translate("metaX_main", "Prefix of Intensity Column"))
        self.comboBox_annotator_peptide_col_name.setStatusTip(_translate("metaX_main", " e.g. \"Stripped.Sequence\" in DIA-NN result"))
        self.comboBox_annotator_peptide_col_name.setItemText(0, _translate("metaX_main", "Sequence"))
        self.comboBox_annotator_peptide_col_name.setItemText(1, _translate("metaX_main", "Stripped.Sequence"))
        self.comboBox_annotator_protein_col_name.setStatusTip(_translate("metaX_main", " e.g. \"Protein.Group\" in DIA-NN result"))
        self.comboBox_annotator_protein_col_name.setItemText(0, _translate("metaX_main", "Proteins"))
        self.comboBox_annotator_protein_col_name.setItemText(1, _translate("metaX_main", "Protein.Group"))
