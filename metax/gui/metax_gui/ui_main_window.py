...
class Ui_metaX_main(object):
    def setupUi(self, metaX_main):
        ...
        self.lineEdit_annotator_protein_col_name = QtWidgets.QLineEdit(self.scrollAreaWidgetContents_9)
        ...
        self.lineEdit_annotator_peptide_col_name = QtWidgets.QLineEdit(self.scrollAreaWidgetContents_9)
