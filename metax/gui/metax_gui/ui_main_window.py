...
class Ui_metaX_main(object):
    def setupUi(self, metaX_main):
        ...
        self.scrollAreaWidgetContents_10.setGeometry(QtCore.QRect(0, 0, 1489, 245))
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 1457, 364))
        ...
        self.gridLayout_74.addWidget(self.scrollArea_pep_direct_to_otf_settings, 6, 0, 1, 4)
        ...
        self.gridLayout_74.addWidget(self.pushButton_pep_direct_to_otf_open_metaumbra_gui, 4, 0, 1, 1)
        ...
        self.gridLayout_74.addLayout(self.gridLayout_78, 4, 2, 1, 1)
